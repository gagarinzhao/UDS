...
```{r import and cleaning center info/table 7}
uds2019centerinfo = 
...
write.xlsx(uds2019info.t7, ".\\uds2019info_T7.xlsx", overwrite = TRUE)
```
...
write.xlsx(uds2018info.t7, ".\\uds2018info_T7.xlsx", overwrite = TRUE)
```
...
write.xlsx(uds2017info.t7, ".\\uds2017info_T7.xlsx", overwrite = TRUE)
```
...
uds2015table7_1 = 
  readxl::read_excel(".\\EHB UDS2015DataDumpLA22Aug2016.xlsx", sheet = "Table7_1") %>% 
  select(-GrantNumber)

uds2015table7_2 = 
  readxl::read_excel(".\\EHB UDS2015DataDumpLA22Aug2016.xlsx", sheet = "Table7_2") %>% 
  select(-GrantNumber)
...
write.xlsx(uds2015info.t7, ".\\uds2015info_T7.xlsx", overwrite = TRUE)
```
...
write.xlsx(uds2014info.t7, ".\\uds2014info_T7.xlsx", overwrite = TRUE)
```
