...
var_label(uds2017table5) = list(T5_L1_Ca = "Family Practitioner FTE",
...
var_label(uds2017table5a) = list(T5A_L1_Ca = "FT/PT Family Physicians Persons",
...
``` r
uds2017table6a = 
  readxl::read_excel(".\\UDS2017DataDumpLA14Aug2018.xlsx", sheet = "Table6A") %>% 
  select(-GrantNumber)

var_label(uds2017table6a) = list(T6a_L1and2_Ca = "Symp/Asymp HIV # Visits",
...
``` r
uds2017info.t5.T5A = full_join(uds2017centerinfo, uds2017table5, uds2017table5a, by = "BHCMISID")
```

Export table as an Excel:

``` r
write.xlsx(uds2017info.t5.T5A, "C:\\Users\\GagarinZhao\\Documents\\Work\\UDS\\Data Wrangling\\uds2017info_T5_T5A.xlsx")
```
