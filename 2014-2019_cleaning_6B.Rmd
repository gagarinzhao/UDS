...
write.xlsx(uds2019info.t6b, ".\\uds2019info_T6b.xlsx", overwrite = TRUE)
```
...
write.xlsx(uds2018info.t6b, ".\\uds2018info_T6b.xlsx", overwrite = TRUE)
```
...
write.xlsx(uds2017info.t6b, ".\\uds2017info_T6b.xlsx", overwrite = TRUE)
```
...
write.xlsx(uds2016info.t6b, ".\\uds2016info_T6b.xlsx", overwrite = TRUE)
```
...
uds2015table6b = 
  readxl::read_excel(".\\EHB UDS2015DataDumpLA22Aug2016.xlsx", sheet = "Table6B") %>% 
  select(-GrantNumber)
...
write.xlsx(uds2015info.t6b, ".\\uds2015info_T6b.xlsx", overwrite = TRUE)
```
...
write.xlsx(uds2014info.t6b, ".\\uds2014info_T6b.xlsx", overwrite = TRUE)
```
