...
uds2015table5 = 
  readxl::read_excel(".\\EHB UDS2015DataDumpLA22Aug2016.xlsx", sheet = "Table5") %>% 
  select(-GrantNumber)

# var_label(uds2015table5) = list(T5_L1_Ca = "Family Practitioner FTE",
...
uds2015table5a =
  readxl::read_excel(".\\EHB UDS2015DataDumpLA22Aug2016.xlsx", sheet = "Table5A") %>%
  select(-GrantNumber)
...
# var_label(uds2015table5a) = list(T5A_L1_Ca = "FT/PT Family Physicians Persons",
...
uds2015table6a = 
  readxl::read_excel(".\\EHB UDS2015DataDumpLA22Aug2016.xlsx", sheet = "Table6A") %>% 
  select(-GrantNumber)

# var_label(uds2015table6a) = list(T6a_L1and2_Ca = "Symp/Asymp HIV # Visits",
...
```{r export xlsx}
write.xlsx(uds2015info.t5.T5A, "C:\\Users\\GagarinZhao\\Documents\\Work\\UDS\\Data Wrangling\\uds2015info_T5_T5A.xlsx")
```
