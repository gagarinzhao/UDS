...
write.xlsx(uds2014to2019.t7_demographics, ".\\uds2014to2019info_T7_demographics.xlsx", overwrite = TRUE)
```
...
# Export the file
saveWorkbook(OUT, "Table7demographics_final_variables_2014_2019.xlsx", overwrite = TRUE)
