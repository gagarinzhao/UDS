---
title: "2014-2019 cleaning table 7"
author: "Gagarin Zhao"
date: "8/27/2020"
...
write.xlsx(uds2019info.t3a.t3b.t4, ".\\uds2019info_T3A_T3B_T4.xlsx", overwrite = TRUE)
```
...
write.xlsx(uds2018info.t3a.t3b.t4, ".\\uds2018info_T3A_T3B_T4.xlsx", overwrite = TRUE)
```
...
write.xlsx(uds2017info.t3a.t3b.t4, ".\\uds2017info_T3A_T3B_T4.xlsx", overwrite = TRUE)
```
...
write.xlsx(uds2016info.t3a.t3b.t4, ".\\uds2016info_T3A_T3B_T4.xlsx", overwrite = TRUE)
```

2015 info and table 3a 3b 4: 
```{r import and cleaning center info/table5}
uds2015centerinfo = 
  readxl::read_excel(".\\EHB UDS2015DataDumpLA22Aug2016.xlsx", sheet = "HealthCenterInfo") %>% 
  select(HealthCenterName, BHCMISID, ReportingYear)

uds2015table3A = 
  readxl::read_excel(".\\EHB UDS2015DataDumpLA22Aug2016.xlsx", sheet = "Table3A") %>% 
  select(-GrantNumber)

uds2015table3B = 
  readxl::read_excel(".\\EHB UDS2015DataDumpLA22Aug2016.xlsx", sheet = "Table3B") %>% 
  select(-GrantNumber)

uds2015table4 = 
  readxl::read_excel(".\\EHB UDS2015DataDumpLA22Aug2016.xlsx", sheet = "Table4") %>% 
  select(-GrantNumber)
...
write.xlsx(uds2015info.t3a.t3b.t4, ".\\uds2015info_T3A_T3B_T4.xlsx", overwrite = TRUE)
```
...
write.xlsx(uds2014info.t3a.t3b.t4, ".\\uds2014info_T3A_T3B_T4.xlsx", overwrite = TRUE)
```
