...
write.xlsx(uds2014to2019.t6b, ".\\uds2014to2019info_T6B.xlsx", overwrite = TRUE)
```
...
# Export the file
saveWorkbook(OUT, "quality_of_care_final_variables_6b_2014_2019.xlsx", overwrite = TRUE)
